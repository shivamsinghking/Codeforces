...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        int range = 1000  + 2*10 + 2;
        // range = n + 2m - 1 => adding some extra values for marking dp, to avoid Index out of bound
        long[] dp = new long[range];
        int mod = 1000000000 + 7;
        dp[0] = 1;
        for(int i = 1; i < range; i++){
          dp[i] = (dp[i - 1]*(long)i)%mod;
        }
    ...
    public static void solve(long[] dp) {
     int n = sc.nextInt();
     int m = sc.nextInt();
