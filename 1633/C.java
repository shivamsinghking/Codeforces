...
public class Main {
    ...
    public static void solve() {
      long hc = sc.nextLong(), dc = sc.nextLong();
      long hm = sc.nextLong(), dm = sc.nextLong();

      long k = sc.nextLong(), w = sc.nextLong(), a = sc.nextLong();

      boolean flag = false;
      for(int i = 0; i <= k; i++){
        // first i coins on attack , k - i   coins on sheath
        long hhc = hc + a*(i); // health
        long ddc = dc + w*(k - i); // attack
