...
public class Main {
    ...
    public static void solve() {
        ...
        int min = b - a; // if only adding can make a == b
        for(int i = b; i <= 2*b; i++){
            int moves = i - b;
            moves++; // for OR operation at last
            // making sub-mask -> so that, we can 
            /**
             *16 8 4 2 1
             * 1 0 1 0 1 -> 21 -> a
             * 1 1 0 1 1 -> b
             * 1 1 0 0 0 -> 24 -> final "b"
             * Min we have to add 3 to get to final B(sub-mask of b)
             */
